var YSP = (function(me, $) {
    ...
    me.common = {
                ...
                success: function(data){
                    ...
                    for (var i = 0; i < tracks.length; i++) {
                        ...
                        if(lang_code){
                            ...
                            var _promise = me.common.getSubtitlesByLang(lang_code);
                            langs_promises.push(_promise);
                        }
                    }
                    $.when.apply(me, langs_promises).then(me.common.parseSubtitle);
                },
        ...
        parseKeywords: function(_data, lang){
            ...
            for (var i = 0; i < transcript.length; i++) {
                ...
                if(finding_word) {
                    var name_clear = me.common.replacePunctuation(finding_word.w, '').toLowerCase().trim();
                    if(name_clear !== '') {
        ...
        parseSubtitle: function(){
            ...
            for (var lang in me.options.youtube_subtitles) {
                var parse_result = me.common.parseTranscript(me.options.youtube_subtitles[lang]);
                me.options.transcripts[lang] = parse_result.transcript;
                me.options.keywords[lang] = me.common.parseKeywords(me.options.transcripts[lang], lang);
            }
            console.timeEnd('parseSubtitle');
            me.options.parsedResult.resolve();
        },
        ...
        replacePunctuation: function(str, replacement){ // from http://stackoverflow.com/a/21396529/3522596
